...
void MainWindow::user_get(){
    ...
    QUrl url = QUrl("https://api.vk.com/method/users.get?user_ids=" + id + "&fields=bdate,nickname,photo_200&access_token=53b82c4953b82c4953b82c491b53cc7e8f553b853b82c490c387e29807cb6afa83b19f8&v=5.103");
...
void MainWindow::friends_get(){
    ...
    QUrl url_friends = QUrl("https://api.vk.com/method/friends.get?user_id=" + id + "&access_token=53b82c4953b82c4953b82c491b53cc7e8f553b853b82c490c387e29807cb6afa83b19f8&v=5.103");
...
void MainWindow::photo_get(){
    ...
    if (response->error() != QNetworkReply::NoError) {
        QMessageBox msgBox;
           ...
           msgBox.setText("пользователя не существует");
