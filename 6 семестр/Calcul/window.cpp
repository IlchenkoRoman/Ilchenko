...
Window::Window(QWidget *parent) : QWidget(parent)
{
        ...
        layout->addWidget(btnPlus, 2, 1);
        layout->addWidget(btnMinus, 2, 2);
        layout->addWidget(btnDiv, 2, 3);
        layout->addWidget(btnMult, 3, 1);
        layout->addWidget(btnRoot, 3, 2);
        layout->addWidget(btnPow, 3, 3);
        layout->addWidget(btnLn, 4, 1);
        layout->addWidget(btnSin, 4, 2);
        layout->addWidget(btnCos, 4, 3);
        layout->addWidget(btnTan, 5, 2);
